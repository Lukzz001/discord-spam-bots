...
userToken = ['NTk4NjcwODY1MjAyMTUxNDI1.YNuFfg.DycdMZt3rrmDST4QyGc_zn97AEM'] # User Tokens here. example 'token','token' | 'email:pass', 'token'
DiscordChannel = '849671687952007178' # Channel ID,
